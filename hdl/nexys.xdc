...
##Switches
 ...
 set_property -dict { PACKAGE_PIN T8    IOSTANDARD LVCMOS33 } [get_ports { B[0] }]; #IO_L24N_T3_34 Sch=B[0]
 set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS33 } [get_ports { B[1] }]; #IO_25_34 Sch=B[1]
 set_property -dict { PACKAGE_PIN R16   IOSTANDARD LVCMOS33 } [get_ports { B[2] }]; #IO_L15P_T2_DQS_RDWR_B_14 Sch=B[2]
 set_property -dict { PACKAGE_PIN T13   IOSTANDARD LVCMOS33 } [get_ports { B[3] }]; #IO_L23P_T3_A03_D19_14 Sch=B[3]
 set_property -dict { PACKAGE_PIN H6    IOSTANDARD LVCMOS33 } [get_ports { B[4] }]; #IO_L24P_T3_35 Sch=B[4]
 set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { B[5] }]; #IO_L20P_T3_A08_D24_14 Sch=B[5]
 set_property -dict { PACKAGE_PIN U11   IOSTANDARD LVCMOS33 } [get_ports { B[6] }]; #IO_L19N_T3_A09_D25_VREF_14 Sch=B[6]
 set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { B[7] }]; #IO_L21P_T3_DQS_14 Sch=B[7]
...
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { Y[0] }]; #IO_L16N_T2_A15_D31_14 Sch=Y[0]
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33 } [get_ports { Y[1] }]; #IO_L14N_T2_SRCC_14 Sch=Y[1]
set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33 } [get_ports { Y[2] }]; #IO_L22P_T3_A05_D21_14 Sch=Y[2]
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { Y[3] }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 Sch=Y[3]
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33 } [get_ports { Y[4] }]; #IO_L16P_T2_CSI_B_14 Sch=Y[4]
set_property -dict { PACKAGE_PIN V14   IOSTANDARD LVCMOS33 } [get_ports { Y[5] }]; #IO_L22N_T3_A04_D20_14 Sch=Y[5]
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { Y[6] }]; #IO_L20N_T3_A07_D23_14 Sch=Y[6]
set_property -dict { PACKAGE_PIN V11   IOSTANDARD LVCMOS33 } [get_ports { Y[7] }]; #IO_L21N_T3_DQS_A06_D22_14 Sch=Y[7]
...
##Buttons
 ...
 set_property -dict { PACKAGE_PIN C12   IOSTANDARD LVCMOS33 } [get_ports { CarryIn }]; #IO_L3P_T0_DQS_AD1P_15 Sch=cpu_resetn
 set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { Sel[0] }]; #IO_L9P_T1_DQS_14 Sch=btnc
 set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { Sel[1] }]; #IO_L4N_T0_D05_14 Sch=btnu
 set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { Sel[2] }]; #IO_L12P_T1_MRCC_14 Sch=btnl
 set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { Sel[3] }]; #IO_L10N_T1_D15_14 Sch=btnr
 set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { Sel[4] }]; #IO_L9N_T1_DQS_D13_14 Sch=btnd
